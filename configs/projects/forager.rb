project "forager" do |proj|
  platform = proj.get_platform

  # Project level settings our components will care about
  if platform.is_windows?
    proj.setting(:company_name, "Puppet Inc")
    proj.setting(:pl_company_name, "Puppet Forager")
    proj.setting(:company_id, "PuppetForager")
    proj.setting(:common_product_id, "PuppetForagerInstaller")
    proj.setting(:puppet_service_name, "forager")
    proj.setting(:product_id, "Forager")
    proj.setting(:upgrade_code, "2AD3D11C-61B3-4710-B106-B4FDEC5FA358")
    if platform.architecture == "x64"
      proj.setting(:product_name, "Puppet Forager (64-bit)")
      ...
      proj.setting(:product_name, "Puppet Forager")
    ...
    proj.setting(:sysconfdir, File.join("C:", proj.base_dir, proj.company_id, proj.product_id))
    ...
    proj.setting(:install_root, "/var/tmp/puppetlabs/opt")
    if platform.is_eos?
      ...
      proj.setting(:sysconfdir, "/var/tmp/puppetlabs/etc")
    end
    proj.setting(:logdir, "/var/tmp/puppetlabs/var/log")
    proj.setting(:piddir, "/var/tmp/puppetlabs/var/run")
